...
const Constraints = {
    ...
    companyIsOptional : [
        ...
        body('country').if(body('country').exists()).isString(),
        body('contact_person').if(body('contact_person').exists()).isString(),
        body('rc_number').if(body('has_company').exists()).isString(),
        body('company_website').if(body('company_website').exists()).isString(),
