...
class HubspotController {
    static async createHubspotusers(req,res){
        ...
        batchuser.forEach(async element => {
            ...
            //                             <tr class="row__row" style="Font-family: 'Radio Canada', sans-serif; text-align: center;" align="center">
            //                               <td class="column col-sm-12" width="600" style="Font-family: 'Radio Canada', sans-serif;width: 100%; text-align: center" align="center" valign="top">
            //                                 <a href="" class="highlightbg bold a" style="Font-family: 'Radio Canada', sans-serif; padding: 15px 35px; letter-spacing: 1.5px; font-size: 14px; border-radius: 5px; color: #FFFFFF; text-decoration: none; background-color: #008D40; font-weight: 700; text-align: center;"><span class="a__text" style="Font-family: 'Radio Canada', sans-serif; color: #FFFFFF; text-decoration: none; text-align: center;">Login</span></a>
            //                               </td>
            //                             </tr>
            //                           </table>
            //                         </div>
